...
DEFINE('MAX_GANTTIMG_SIZE_W',24000);
DEFINE('MAX_GANTTIMG_SIZE_H',25000);
...
//---------------
// CONSTRUCTOR	
    function GanttBar($aPos,$aLabel,$aStart,$aEnd,$aCaption="",$aHeightFactor=0.2) {
