...
* @access   public
*/
class soapservidor extends nusoap_base {
	/**
	...
	* @access   public
	*/
	function soapservidor($wsdl=false){
		parent::nusoap_base();
		// turn on debugging?
		global $debug;
...
/**
*
* soapcliente higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $soapcliente = new soapcliente( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $soapcliente->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapcliente);
*
...
* @access   public
*/
class soapcliente extends nusoap_base  {
	...
	* @access   public
	*/
	function soapcliente($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends soapcliente {
	'.$evalStr.'
}';
		return $evalStr;
	}
