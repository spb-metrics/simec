...
(function() {
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
           'http://'+window.location.href.replace('http://','').split("/")[0]+"/includes/timeline/ajax/api/simile-ajax-api.js?bundle=false" :
           'http://'+window.location.href.replace('http://','').split("/")[0]+"/includes/timeline/ajax/api/simile-ajax-api.js";
           //window.location+"public/api/ajax/api/simile-ajax-api.js?bundle=false" :
           //window.location+"public/api/ajax/api/simile-ajax-api.js";
