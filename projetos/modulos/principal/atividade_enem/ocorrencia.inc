	...
	case 'controlar_solucao':
		if ( $_REQUEST['obssolucao'] == 't' ) {
			$sql = sprintf(
				...
				$_REQUEST['obsmedida'],
				$_SESSION['usucpf'],
				$_REQUEST['obsmelhorias'],
				$_REQUEST['obsinfomelhorias'],
				$_REQUEST['obsid']
			);
		} else {
			$sql = sprintf(
...
<script language="javascript" type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		jQuery('input[name=obsmelhorias]').click(function(){
			if(jQuery('input[name=obsmelhorias]:checked').val() == 't'){
				jQuery('#informarMelhorias').show();
			} else {
				jQuery('#informarMelhorias').hide();
			}
		});
		jQuery('input[name=obsmelhorias]:checked').click();
			...
			<?php if( is_array( $restricoes ) ): ?>
				...
				<form method="post" id="formulario_<?= $restricao['obsid'] ?>">
					...
					<table class='tabela' bgcolor="#f5f5f5" style="width:100%; margin-top: 15px;<?= $restricao['obssolucao'] == 't' ? 'color:#454545;' : '' ?>" cellpadding="3">
						<tbody>
							<tr style="background-color: #cccccc">
								<td align='right' style="vertical-align:center; width:25%">&nbsp;</td>
							...
							<tr>
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Descrição:</td>
							...
							<tr>
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Data:</td>
							...
							<tr>
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Autor:</td>
								<td>
									<div>
							...
							<tr>
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Restrição superada?</td>
								<td>
									<?php if( $permissao ): ?>
							...
							<tr>
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Providência:</td>
								<td>
								<?php
							...
							<tr>
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Melhorias</td>
								<td>
									<?php 
									$obsmelhorias = (!$obsmelhorias || $obsmelhorias == 'f') ? 'f' : 't'; 
									?>
										<label title="Indica se existem melhorias">
											<input type="radio" name="obsmelhorias" value="t" <?= $obsmelhorias == 't' ? 'checked="checked"' : '' ?>/>
											Sim
										</label>
										&nbsp;&nbsp;
										<label title="Sem melhorias">
											<input type="radio" name="obsmelhorias" value="f" <?= $obsmelhorias == 'f' ? 'checked="checked"' : '' ?>/>
											Não
										</label>
								</td>
							</tr>
							<tr id="informarMelhorias">
								<td class="SubTituloDireita" style="vertical-align:center; width:25%;">Informar Melhorias:</td>
								<td>
								<?php
								echo campo_textarea( 'obsinfomelhorias', 'N', 'S', '', 70, 2, 250 );
								?>
								</td>
							</tr>
